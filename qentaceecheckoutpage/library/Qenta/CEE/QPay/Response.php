 ...
 */
final class Qenta_CEE_QPay_Response
{
    ...
    /**
     * instantiates an Qenta_CEE_QPay Response object.
     ...
     * @return Qenta_CEE_QPay_Response
     */
    public function __construct(Array $postData, $secret)
    {
        if(count($postData) == 0)
        {
            throw new Qenta_CEE_QPay_Exception('The request is not a valid POST request.');
        }
    ...
    public function validateResponse()
    {
        switch($this->paymentState)
        {
            ...
            case self::STATE_PENDING:
                ...
                break;
            default:
                throw new Qenta_CEE_QPay_Exception('Unexpected paymentState: ' . $this->paymentState);
                break;
        }
        return $this;
    }
    ...
    private function _getResponseFingerprintOrder()
    {
        ...
        {
            throw new Qenta_CEE_QPay_Exception('ResponseFingerprintOrder has not been returned.');
        }
    ...
    private function _compateFingerprints()
    {
        if($this->responseFingerprint != $this->_fingerprintString)
        {
            ...
            throw new Qenta_CEE_QPay_Exception('Fingerprint missmatch. Fingerprints are not equal.');
        }
        return true;
    }
