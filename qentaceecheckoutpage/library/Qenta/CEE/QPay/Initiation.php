 ...
 */
final class Qenta_CEE_QPay_Initiation
{  
    ...
    /**
     * creates an instance of {@link Qenta_CEE_QPay_Initiation}
     * 
     ...
     * @return Qenta_CEE_QPay_Initiation 
     */
     ...
     * @param Qenta_CEE_QPay_ConsumerData $consumerData
     * @return Qenta_CEE_QPay_Initiation 
     */
    public function addConsumerData(Qenta_CEE_QPay_ConsumerData $consumerData)
    {
    ...
    public function initiate($config = null)
    {
        ...
        {
            throw new Qenta_CEE_QPay_Exception($e->getMessage(), $e->getCode(), $e);
        }
    ...
    private function _proceedResponse($responseObject)
    {
        ...
        {
            throw new Qenta_CEE_QPay_Exception(urldecode($response[1]));
        }
        else
        {
            throw new Qenta_CEE_QPay_Exception('Invalid response from QPay');
        }
    }
